...
const AllPauseModal: React.FC<{ onClose: () => void, isOpen: boolean }> = ({ onClose, isOpen }) => {
  ...
  const panelClass = "doro-pause-panel-in w-full max-w-md overflow-hidden rounded-[1.75rem] p-6 shadow-[0_34px_90px_-44px_rgba(0,0,0,0.92),inset_0_1px_0_rgba(255,255,255,0.16)] md:p-8";
  ...
  if (isConfirmingEnd) {
      return (
        <div className={overlayClass} style={surfaceStyle}>
          <PauseMotionStyles />
          <div className="doro-pause-panel-in w-full max-w-sm overflow-hidden rounded-[1.6rem] p-6 shadow-[0_34px_90px_-44px_rgba(0,0,0,0.92),inset_0_1px_0_rgba(255,255,255,0.16)] md:p-7" style={surfaceStyle}>
  ...
  return (
    <div className={overlayClass} style={surfaceStyle}>
      ...
      <div className={`${panelClass} flex flex-col gap-5`} style={surfaceStyle}>
        <div className="doro-pause-item-in text-center" style={{ ['--doro-pause-delay' as any]: '70ms' }}>
        ...
        <div className="doro-pause-item-in flex gap-3 w-full" style={{ ['--doro-pause-delay' as any]: '185ms' }}>
          <button 
            onClick={onClose} 
...
export const ResumeModal: React.FC = () => {
  ...
  const secondaryButtonClass = `
    doro-pause-item-in mt-3 w-full rounded-full bg-white/[0.055] px-4 py-2.5 text-[10px] font-bold uppercase tracking-[0.14em]
  ...
  return (
    <div className="doro-pause-surface-in fixed inset-0 z-[60] flex items-center justify-center p-3 md:p-4" style={surfaceStyle}>
       <PauseMotionStyles />
       <div className="doro-pause-panel-in w-full max-w-3xl overflow-hidden rounded-[1.8rem] p-5 shadow-[0_34px_90px_-44px_rgba(0,0,0,0.92),inset_0_1px_0_rgba(255,255,255,0.16)] md:p-8" style={surfaceStyle}>
         
         <div className="text-center">
            <div className="doro-pause-item-in text-[10px] font-bold uppercase tracking-[0.18em] text-white/42" style={{ ['--doro-pause-delay' as any]: '50ms' }}>System Paused</div>
            <div className="doro-pause-time-in mt-3 font-sans text-[4.75rem] font-bold leading-none text-white tabular-nums md:text-[6rem]">{timeStr}</div>
